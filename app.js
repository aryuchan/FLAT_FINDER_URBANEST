...
const App = {
  ...
  async route() {
    ...
    let module = null;
    if (portal.includes("tenant"))
      module = typeof Tenant !== "undefined" ? Tenant : null;
    if (portal.includes("owner"))
      module = typeof Owner !== "undefined" ? Owner : null;
    if (portal.includes("admin"))
      module = typeof Admin !== "undefined" ? Admin : null;
    ...
    // Role Guard
    if (portal.includes("tenant") && appState.currentUser.role !== "tenant")
      return (window.location.href = "/");
    if (portal.includes("owner") && appState.currentUser.role !== "owner")
      return (window.location.href = "/");
    if (portal.includes("admin") && appState.currentUser.role !== "admin")
      return (window.location.href = "/");
