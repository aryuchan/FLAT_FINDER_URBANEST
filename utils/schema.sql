...
CREATE TABLE IF NOT EXISTS flats (
  ...
  preferred_tenants ENUM('any', 'family', 'bachelors', 'working_women', 'students') DEFAULT 'any',
  food_preference ENUM('any', 'veg', 'nonveg') DEFAULT 'any',
  furnished TINYINT(1) DEFAULT 0,
  bathrooms VARCHAR(10) DEFAULT '',
  facing VARCHAR(50) DEFAULT '',
  landmarks TEXT,
  pets_allowed TINYINT(1) DEFAULT 0,
  smoking_allowed TINYINT(1) DEFAULT 0,
  visitors_allowed TINYINT(1) DEFAULT 0,
  images LONGTEXT,
  amenities LONGTEXT,
