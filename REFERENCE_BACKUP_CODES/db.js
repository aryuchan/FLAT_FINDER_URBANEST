...
const poolConfig = {
  ...
  // Keeps idle connections alive; Railway MySQL proxy drops idle connections after ~60s.
  enableKeepAlive:       true,
  keepAliveInitialDelay: 30000,
};

// ── SSL — Railway internal vs public URL ──────────────────────────
// mysql.railway.internal → private network, no SSL needed.
// *.railway.app / roundhouse.proxy.* → public URL, needs SSL.
if (
  DB_HOST.includes('railway.app') ||
  DB_HOST.includes('roundhouse.proxy') ||
  DB_HOST.includes('monorail.proxy')
) {
